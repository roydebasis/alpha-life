...
jQuery(function ($) {
    ...
    $(window).scroll(function () {
        if ($(window).scrollTop() > 10) {
            $(".main-nav, .navbar-fixed-top, .tt-default-nav").addClass(
                "sticky"
            );
        } else {
            $(".main-nav, .navbar-fixed-top, .tt-default-nav").removeClass(
                "sticky"
            );
        }
    });
    ...
    if ($("#myMap").length > 0) {
        ...
        var contentString =
            '<div id="mapcontent">' +
            "<p>69Studio, 795 Folsom Ave, San Francisco.</p></div>";
