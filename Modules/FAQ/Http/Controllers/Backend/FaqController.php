...
use Log;
use Modules\FAQ\Http\Requests\Backend\FaqRequest;
...
class FaqController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            "faq::backend.$module_path.index_datatable",
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id', 'title', 'url');
    ...
    public function create()
    {
        ...
        return view(
            "faq::backend.$module_name.create",
