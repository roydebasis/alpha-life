...
class Video extends BaseModel
{
    ...
    protected static $logName = 'videos';
    protected static $logOnlyDirty = true;
    protected static $logAttributes = ['name', 'url', 'slug', 'status', 'type', 'meta_title', 'meta_keywords', 'meta_description', 'created_at', 'updated_at'];
