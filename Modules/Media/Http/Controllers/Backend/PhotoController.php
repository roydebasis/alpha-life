...
use Modules\Media\Http\Requests\Backend\PhotoRequest;
...
//    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = 'Photos';

        // module name
        $this->module_name = 'photos';

        // directory path of the module
        $this->module_path = 'photos';

        // module icon
        $this->module_icon = 'fas fa-file-alt';

        // module model name, path
        $this->module_model = "Modules\Media\Entities\Photo";
    }
...
//        Log::info(label_case($module_title.' '.$module_action).' | User:'.Auth::user()->name.'(ID:'.Auth::user()->id.')');
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id', 'name', 'url', 'updated_at');
