...
use Log;
use Modules\Home\Http\Requests\Backend\BulletinRequest;
...
class FooterLinkController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'Footer Links';

        // module name
        $this->module_name = 'footerlinks';

        // directory path of the module
        $this->module_path = 'footerlinks';

        // module icon
        $this->module_icon = 'fas fa-file-alt';

        // module model name, path
        $this->module_model = "Modules\Home\Entities\FooterLink";
    }
    ...
    public function index()
    {
        ...
        return view(
            "home::backend.$module_path.index_datatable",
    ...
    public function create()
    {
        ...
        return view(
            "home::backend.$module_name.create",
    ...
    public function trashed()
    {
        ...
        return view(
            "home::backend.$module_name.trash",
            compact('module_title', 'module_name', "$module_name", 'module_icon', 'module_name_singular', 'module_action')
        );
    }
