...
use Log;
use Modules\Home\Http\Requests\Backend\SliderRequest;
...
class SliderController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->module_model = "Modules\Home\Entities\Slider";
    }
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id', 'name', 'image', 'updated_at');
