...
@section('title')
    {{ __($module_action) }} Premium Due List
@endsection

@section('breadcrumbs')
    <x-backend-breadcrumbs>
        <x-backend-breadcrumb-item type="active" icon='{{ $module_icon }}'>Premium Due List
            ...
            <div class="row">
                <div class="col-8">
                    <h4 class="card-title mb-0">
                        <i class="{{ $module_icon }}"></i> Premium Due List <small class="text-muted">Data Table
